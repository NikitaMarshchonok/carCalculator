...
class Car :
    def __init__(self, name: str, price: int, fuel_economy: float, service_cost: float, insurance_cost: int):
        self.name = name
        self.price = price
...
class ElectricCar:
    ...
    def dynamic_year_cost(self, mileage: int):
        return self.power_consumtion * mileage / 1000 * get_power_price(self)
